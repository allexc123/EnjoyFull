    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 sceneUVs = float2(1,grabSign)*i.screenPos.xy*0.5+0.5 + (float2(_node_7526_var.r,_node_7526_var.g)*_node_7526_var.a*_node_1786*i.vertexColor.a);

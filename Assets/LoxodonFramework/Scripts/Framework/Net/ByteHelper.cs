...
public static class ByteHelper
{
    ...
    public static void WriteTo(this byte[] bytes, int offset, long num)
    {
        ...
        bytes[offset + 2] = (byte)((num >> 16) & 0xff);
        bytes[offset + 3] = (byte)((num >> 24) & 0xff);
        bytes[offset + 4] = (byte)((num >> 32) & 0xff);
        bytes[offset + 5] = (byte)((num >> 40) & 0xff);
        bytes[offset + 6] = (byte)((num >> 48) & 0xff);

...
{
    private static readonly ILog log = LogManager.GetLogger(typeof(CircularBuffer));
    ...
    public override long Length
    {
        get
        {
            ...
            if (c < 0)
            {
                log.ErrorFormat("CircularBuffer count < 0: {0}, {1}, {2}", this.bufferQueue.Count, this.LastIndex, this.FirstIndex);
            }
            return c;
        }
    }
    ...
    /// <returns></returns>
    public async void ReadAsync(Stream stream)
    {
